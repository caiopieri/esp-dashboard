...
public:
    ...
    void onStart(lv_obj_t* root) override {
        ...
        lv_obj_set_style_text_font(_dateDisplay, &lv_font_montserrat_12, 0);
        lv_obj_set_style_text_color(_dateDisplay, lv_color_hex(0xA6ADC8), 0);
        lv_obj_align(_dateDisplay, LV_ALIGN_TOP_LEFT, 6, 38);

        // System Specs Container
        lv_obj_t* statsBox = lv_obj_create(_rootCard);
        lv_obj_set_size(statsBox, 290, 100);
        ...
        lv_obj_set_style_text_font(_ipLabel, &lv_font_montserrat_12, 0);
        ...
        lv_obj_set_style_text_font(_heapLabel, &lv_font_montserrat_12, 0);
